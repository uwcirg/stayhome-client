...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static m4(minF, maxF, minC, maxC) => "Ingrese un valor entre ${minF} y ${maxF} (°F) o ${minC} y ${maxC} (°C). Los valores no válidos no se guardarán.";
  ...
  static _notInlinedMessages(_) => <String, Function> {
    ...
    "about_small" : MessageLookupByLibrary.simpleMessage("acerca"),
    ...
    "attempt_login_text" : MessageLookupByLibrary.simpleMessage("Intentando iniciar sesión..."),
    ...
    "back_to_login_register_small" : MessageLookupByLibrary.simpleMessage("regrese a iniciar sesión / regístrese"),
    ...
    "contact_point_system_email" : MessageLookupByLibrary.simpleMessage("correo electrónico"),
    "contact_small" : MessageLookupByLibrary.simpleMessage("contáctenos"),
    ...
    "enter_response" : MessageLookupByLibrary.simpleMessage("Ingrese la respuesta aquí"),
    ...
    "fiuNH_body" : MessageLookupByLibrary.simpleMessage("Puede optar por compartir su información directamente con el programa NeighborhoodHELP. Si lo hace, ellos sabrán que usted puede tener COVID-19, y el tipo de ayuda que usted y su familia puedan necesitar. Si decide compartir información con NeigborhoodHELP, ellos tendrán acceso a:\n- Sus sintomas, pruebas, e información de su condición de salud,\n- La información general de su ubicación (código postal), Y\n- Su nombre e información de contacto (correo electrónico y/o número de teléfono)."),
    ...
    "gender_female" : MessageLookupByLibrary.simpleMessage("hembra"),
    "gender_male" : MessageLookupByLibrary.simpleMessage("varón"),
    ...
    "languageName" : MessageLookupByLibrary.simpleMessage("Español (ES)"),
    ...
    "logout_small" : MessageLookupByLibrary.simpleMessage("cerrar sesión "),
    ...
    "profile_info_sharing_text" : MessageLookupByLibrary.simpleMessage("No compartiremos la información de su perfil, a menos que nos lo permita seleccionando programas específicos, en la opción “Compartir Información” de abajo."),
    ...
    "profile_small" : MessageLookupByLibrary.simpleMessage("perfil"),
    ...
    "share_contact_info" : MessageLookupByLibrary.simpleMessage("Compartir mi nombre e información de contacto (correo electrónico y/o número de teléfono)"),
    "share_location" : MessageLookupByLibrary.simpleMessage("Compartir mi ubicación general (código postal)"),
    "share_symptoms" : MessageLookupByLibrary.simpleMessage("Compartir mis síntomas, pruebas y condiciones de salud"),
    ...
    "social_distancing_body" : MessageLookupByLibrary.simpleMessage("Puede optar por compartir su información directamente con el estudio de Distanciamiento Social. Si decide compartir información, ellos tendrán acceso a:\n- Sus sintomas, pruebas, e información de su condición de salud,\n- La información general de su ubicación (código postal), Y\n- Su nombre e información de contacto (correo electrónico y/o número de teléfono)."),
    "social_distancing_title" : MessageLookupByLibrary.simpleMessage("estudio de Distanciamiento Social"),
    "social_distancing_toggle" : MessageLookupByLibrary.simpleMessage("Compartir mi información con el estudio de Distanciamiento Social"),
    ...
    "whatlink_title" : MessageLookupByLibrary.simpleMessage("¿Qué es StayHome?")
  };
}
