...
class AppLocalizationDelegate extends LocalizationsDelegate<S> {
  ...
  List<Locale> get supportedLocales {
    return const <Locale>[
      Locale.fromSubtags(languageCode: 'en'), Locale.fromSubtags(languageCode: 'es'), Locale.fromSubtags(languageCode: 'fr', countryCode: 'HT'), Locale.fromSubtags(languageCode: 'mn'), Locale.fromSubtags(languageCode: 'de', countryCode: 'DE'),
    ];
  }
